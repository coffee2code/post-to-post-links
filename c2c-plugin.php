...
if ( ! class_exists( 'c2c_EasyPostToPostLinks_Plugin_043' ) ) :

abstract class c2c_EasyPostToPostLinks_Plugin_043 {
	 ...
	 * @since 036
	 */
	public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'easy-post-to-post-links' ), '036' ); }
	 ...
	 * @since 036
	 */
	public function __wakeup() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'easy-post-to-post-links' ), '036' ); }
